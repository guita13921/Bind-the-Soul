...
public class HS_WhiteMageController : MonoBehaviour
{
    ...
    void OnDrawGizmosSelected()
    {
        ...
        Gizmos.DrawWireSphere(transform.position, skillsRange);
    }
    ...
    public IEnumerator FastPlay(int EffectNumber, float castDelay, float endDelay)
    {
        ...
        if (EffectNumber == 1 || EffectNumber == 3) StartCoroutine(cameraShaker.Shake(0.3f, 5, 0.5f, 0));
        if (EffectNumber == 2 || EffectNumber == 5 || EffectNumber == 7)
        {
            ...
            StartCoroutine(cameraShaker.Shake(0.4f, 5, 1f, 0.4f));
            if (EffectNumber == 5) StartCoroutine(cameraShaker.Shake(0.5f, 5, 2f, castDelay));
        ...
        if (Prefabs[EffectNumber].GetComponent<HS_FrontAttack>() != null)
        {
            ...
            if (casting)
            {
                ...
                else
                {
                    ...
                    if (EffectNumber == 0)
                    {
                        ...
                        StartCoroutine(cameraShaker.Shake(0.3f, 6, 3, 0));
                    }
                    if (EffectNumber == 6)
                    {
                        anim.SetTrigger("Attack2");
                        StartCoroutine(cameraShaker.Shake(0.45f, 6, 0.5f, 0.8f));
                    }
                    if (EffectNumber == 3)
                    {
                        anim.SetTrigger("Attack2");
