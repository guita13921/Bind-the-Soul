...
public class PlayerAction : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (
            Physics.Raycast(Camera.position, Camera.forward, out RaycastHit hit, MaxUseDistance)
        ...
        )
        {
            ...
            UseText.transform.rotation = Quaternion.LookRotation(
                (hit.point = Camera.position).normalized
            );
        }
        else
        {
